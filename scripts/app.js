...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when('/mediaPlayer', {
            templateUrl: 'mediaPlayer/views/mediaPlayer.html',
            controller: 'MediaPlayerCtrl',
            settings: {
                viewName: 'Media Player Test Page',
            }
        })
        .otherwise({
...
function initDec() {
    ...
    try {
        ...
        init(decCallback, ["media"], 'myFirstApp');
    } catch (e) {
...
app.run(function ($rootScope) {
    ...
    $rootScope.appLinks = [
        ...
        { text: 'Media Player', desc: 'Media Player Test Page', href: '#/mediaPlayer', selected: false }
    ];
});
