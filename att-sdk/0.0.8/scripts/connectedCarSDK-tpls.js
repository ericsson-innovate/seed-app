...
angular.module('connectedCarSDK.tpls', ['templates/attAlert.html', 'templates/attBadge.html', 'templates/attContent.html', 'templates/attDrawer.html', 'templates/attDropdown.html', 'templates/attFooter.html', 'templates/attHeader.html', 'templates/attListView.html', 'templates/attLoader.html', 'templates/attMediaPlayer.html', 'templates/attMenu.html', 'templates/attPinPad.html', 'templates/attProgressBar.html', 'templates/attSimError.html', 'templates/attSlider.html', 'templates/attVehicleInMotion.html', 'templates/carousel/carousel.html', 'templates/carousel/slide.html', 'templates/modal/backdrop.html', 'templates/modal/window.html', 'templates/tabs/attTab.html', 'templates/tabs/attTabset.html']);
...
angular.module("templates/attDrawer.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/attDrawer.html",
    "<div class=\"att-drawer\" ng-show=\"showDrawer\" ng-transclude></div>\n" +
    "\n" +
    "\n" +
    "");
}]);
...
angular.module("templates/attHeader.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/attHeader.html",
    "<div class=\"att-header att-header-animation\">\n" +
...
angular.module("templates/attLoader.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/attLoader.html",
    "<div class=\"att-loader\" ng-show=\"isVisible\">\n" +
    "    <div class=\"circles\">\n" +
...
angular.module("templates/modal/window.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/modal/window.html",
    "<div tabindex=\"-1\" role=\"dialog\" class=\"modal fade att-modal animated-short modal-animation\" ng-class=\"{'modal-animation': animate}\"  ng-click=\"close($event)\">\n" +
